export const faqs = [
  {
    ...
    answer:
      "Yes! Powered by advanced AI models. Every excuse is unique, context-aware, and 100% original — no boring templates.",
  },
  {
    question: "Can I use these excuses in real life?",
    answer:
